...
export namespace Prisma {
  ...
  */
  ...
  export type user_profileOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"user_id" | "goal" | "experience" | "days_per_week" | "session_length" | "equipment" | "injuries" | "preferred_split" | "updated_at", ExtArgs["result"]["user_profile"]>
  ...
  interface user_profileFieldRefs {
    ...
    readonly goal: FieldRef<"user_profile", 'String'>
    readonly experience: FieldRef<"user_profile", 'String'>
    readonly days_per_week: FieldRef<"user_profile", 'Int'>
    readonly session_length: FieldRef<"user_profile", 'Int'>
    readonly equipment: FieldRef<"user_profile", 'String'>
    readonly injuries: FieldRef<"user_profile", 'String'>
    readonly preferred_split: FieldRef<"user_profile", 'String'>
  ...
  export type user_profileWhereInput = {
    ...
    goal?: StringFilter<"user_profile"> | string
    experience?: StringFilter<"user_profile"> | string
    days_per_week?: IntFilter<"user_profile"> | number
    session_length?: IntFilter<"user_profile"> | number
    equipment?: StringFilter<"user_profile"> | string
    injuries?: StringNullableFilter<"user_profile"> | string | null
    preferred_split?: StringFilter<"user_profile"> | string
  ...
  export type user_profileScalarWhereWithAggregatesInput = {
    ...
    goal?: StringWithAggregatesFilter<"user_profile"> | string
    experience?: StringWithAggregatesFilter<"user_profile"> | string
    days_per_week?: IntWithAggregatesFilter<"user_profile"> | number
    session_length?: IntWithAggregatesFilter<"user_profile"> | number
    equipment?: StringWithAggregatesFilter<"user_profile"> | string
    injuries?: StringNullableWithAggregatesFilter<"user_profile"> | string | null
    preferred_split?: StringWithAggregatesFilter<"user_profile"> | string
